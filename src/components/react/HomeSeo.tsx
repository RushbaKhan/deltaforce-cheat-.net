	...
	const categories = [
		{
			...
			links: [
				...
				{ href: '/delta-force-radar/', labelKey: 'homeSeo.linkRadar' },
			],
		},
		{
			...
			links: [
				...
				{ href: '/delta-force-cheats/', labelKey: 'homeSeo.linkUndetected' },
		...
		},
		{
			...
			links: [
				...
				{ href: '/delta-force-cheats/', labelKey: 'homeSeo.linkTarkovCheats' },
				{ href: '/features/', labelKey: 'homeSeo.linkAllFeatures' },
			],
		},
		{
