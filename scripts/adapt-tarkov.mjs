...
const REPLACEMENTS = [
	['https://warzonehacks.net', 'https://deltaforcecheat.net'],
	['https://www.warzonehacks.net', 'https://www.deltaforcecheat.net'],
	['www.warzonehacks.net', 'www.deltaforcecheat.net'],
	['warzonehacks.net', 'deltaforcecheat.net'],
	['support@warzonehacks.net', 'support@deltaforcecheat.net'],
	['support@warzonescheats.net', 'support@deltaforcecheat.net'],
	['warzonescheats.net', 'deltaforcecheat.net'],
	['warzonescheats.com', 'deltaforcecheat.net'],
	['warzonescheats.xyz', 'deltaforcecheat.net'],
	...
	['"name": "warzone-hacks"', '"name": "deltaforcecheat"'],
	...
	['operators', 'PMCs'],
	['UAV', 'extract timer'],
	['warzoneImages', 'deltaForceImages'],
	["from './warzone'", "from './delta-force'"],
	["from '../data/warzone'", "from '../data/delta-force'"],
	["from '../../data/warzone'", "from '../../data/delta-force'"],
...
async function main() {
	console.log('Adapting Warzone Hacks → Tarkov Cheats (deltaforcecheat.net)...\n');
